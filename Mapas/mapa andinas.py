...
# Abrir Datos
# =============================================================================
lenguas_Ricardo = pd.read_csv('/home/felipe/WINDOWS/Código útil/Intentos de trabajos/negacion - copia/negacion/andean languages.csv', on_bad_lines='skip', sep=';')
areas = pd.read_csv('/home/felipe/WINDOWS/Código útil/Intentos de trabajos/negacion - copia/negacion/areas.csv',sep=',')
lenguas_areas = pd.read_csv("/home/felipe/WINDOWS/Código útil/Intentos de trabajos/Wals/languages.csv",sep=',',encoding='utf-8')
...
plt.savefig(r'/home/felipe/WINDOWS/Código útil/lenguas_sudamerica1.jpg', format='jpg', transparent=True, bbox_inches='tight',dpi=800)
